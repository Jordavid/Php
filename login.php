    ...
    try {
        ...
        $stmt->execute([$name, $password]);
            ...
            if( $stmt->rowCount() > 0 ){
                ...
                header("Location: profile.php?id= " . $_SESSION['userInfo']['ID']);
                exit(0);
            } else {
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-6 col-xs-offset-3" style="border: 1px dashed white; margin-top: 8px; background: #122b40; border-radius: 10px;">
            <h2 class="text-center" style="color: white; font-weight: 800">Login <span class="glyphicon glyphicon-hand-down"></span> </h2>
            ...
            <form action="#" method="POST">
                <div class="form-group">
                    ...
                    <input type="text" id="username" v-model="name" class="form-control" placeholder="Username" name="username" value="<?= (isset($_POST['username']))? $_POST['username'] : '';?>">
                    <BR>
                    <label for="password">Password</label>
                    <input type="password" name="password" id="password" placeholder="Password" class="form-control">
                    <br>

                    <button type="submit" class="btn btn-primary btn-block" name="b_log">Login</button>
                </div>
            </form>
